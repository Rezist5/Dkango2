...
from .views import (user_create, users, user_update, user_delete,
                    category_create, categories, category_update, category_delete,
                    product_create, products, product_update, product_delete, product_read)
