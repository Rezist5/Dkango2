...
def login(request):
    ...
    context = links_m(title=title, login_form=login_form, next=_next)
...
def register(request):
    ...
    context = links_m(title=title, register_form=register_form)
...
def edit(request):
    ...
    context = links_m(title=title, edit_form=edit_form)
